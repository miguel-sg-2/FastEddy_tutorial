...
Horizontally-averaged vertical profiles of turbulence quantities  at t=3 h (FE_TEST.540000) [perturbations are computed at each point relative to the previous 1-hour mean, and then horizontally averaged]:
